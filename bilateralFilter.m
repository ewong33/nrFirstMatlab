...
gtPngFile = [inputDir, '/bilateralFilteredImages/groundTruth.png'];
...
for k = 1:numIterations
    smoothedLAB = imbilatfilt(imLAB, DegreeOfSmoothing, k);
    ...
    imwrite(smoothedRGB, fullfile(outputDir, ['/bilateralFilteredImages/' num2str(k), '_bilateral_', num2str(DegreeOfSmoothing), '_Window5_Search21', '.png'])); 
...
saveas(gcf, fullfile(outputDir, ['/bilateralFilteredImages/bilateralFilter.png'])); % Save the current figure as a PNG file
disp(['Plot saved']);
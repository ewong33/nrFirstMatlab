...
for k = 1:numIterations
    ...
    imwrite(smoothedRGB, fullfile(outputDir, ['/diffusionFilteredImagesL/' num2str(k), '_diffusion_DoS_', num2str(DegreeOfSmoothing), '_decay_exp.png'])); 

    %cropImage = smoothedLAB(200:900, 1750:2450, 1); 
    cropImage = smoothedLAB(200:900, 1650:2350, 1);

...
for k = 1:numImages
    ...
    temp = medfilt2(imLAB(:,:,1), [filterDim filterDim]); 
    ...
    %imwrite(medianImage, fullfile(outputDir, ['/medianFilteredImagesL_5_3D/' outString, '_medfilt_', num2str(filterDim), '.png'])); 
    imwrite(medianImage, fullfile(outputDir, ['/medianFilteredImagesL_3_1D/' outString, '_medfilt_', num2str(filterDim), '.png'])); 
